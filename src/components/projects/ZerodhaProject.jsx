const PortfolioProject = () => {
  ...
  return (
    <div className="h-full text-xl text-black xl:text-3xl font-medium pt-[3rem] selection:bg-orange-100 overflow-hidden">
        <div data-scroll data-scroll-speed="1.2" className='w-fit h-[2rem] flex items-center relative top-[3rem]'>
          <h1>4. Zerodha Kite Inspired Website.</h1>
          <img src="src\assets\kiteLogo.svg" alt="" className=' w-8 h-6 -translate-y-[10%]' />
        </div>
        <div className='w-full h-fit bg-orange-50 rounded-lg mt-16 pr-[1rem] shadow-md shadow-[#f5d0d0] overflow-y-scroll lg:overflow-hidden'>
          <div className="w-fit h-[80vh] sm:h-[100vh] relative left-4 top-4 flex ">
            <div className="pr-0">
              <div>
              ...
              <div className='flex flex-col justify-center items-center text-start h-fit xl:scale-75 relative top-10 xl:top-0 text-orange-200'>
                ...
                <img src="src\assets\zerodhaWebsiteFrontPage.png" alt="Zerodha website" className='sm:w-[70%] rounded-lg' />
              </div>
            </div>
          </div>
        </div>
